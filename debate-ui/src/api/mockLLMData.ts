...
export const MOCK_LLM_PROVIDERS = [
  ...
  {
    name: "ollama",
    models: ["llama2", "mistral", "mixtral", "codellama", "neural-chat"],
    features: {
      streaming: true,
...
export const MOCK_DEBATES = [
  {
    ...
    description:
      "A comprehensive debate about the positive and negative impacts of artificial intelligence on modern society.",
    status: "completed",
    participants: [
      {
        id: "p1",
  ...
  },
  {
    ...
    description:
      "Discussing the pros and cons of remote work compared to traditional office environments.",
    status: "in_progress",
    participants: [
      {
        id: "p3",
