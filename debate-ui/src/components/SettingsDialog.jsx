...
const SettingsDialog = () => {
  ...
  const handleClearCache = async () => {
    if (
      window.confirm('Are you sure you want to clear all cached data? This will reload the page.')
    ) {
      setLoading(true);
      try {
        await clearCache();
        ...
        <div className='space-y-6'>
          ...
          <div className='bg-gray-50 rounded-lg p-4'>
            ...
            <div className='flex items-center space-x-2'>
              ...
              {!isOnline && (
                <span className='text-sm text-gray-600'>Some features may be limited</span>
              )}
            </div>
          </div>
          ...
          <div className='bg-gray-50 rounded-lg p-4'>
            ...
            <div className='space-y-3'>
              <div className='flex items-center justify-between'>
                ...
                <Badge
                  className={
                    isInstalled ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
                  }
                >
              ...
              {!isInstalled && installPrompt && (
                <Button onClick={handleInstallPWA} disabled={loading} className='w-full'>
            ...
            <div className='space-y-3'>
              <div className='flex items-center justify-between'>
                <div>
                  ...
                  <p className='text-sm text-gray-600'>Get notified about debate updates</p>
                </div>
                <Badge
                  className={
                    notificationsEnabled
              ...
              {!notificationsEnabled && (
                <Button onClick={handleNotificationPermission} variant='outline' className='w-full'>
          ...
          <div className='bg-gray-50 rounded-lg p-4'>
            ...
            <div className='space-y-3'>
              <div className='flex items-center justify-between'>
                ...
                <Badge className={getCacheStatusColor(cacheStatus)}>{cacheStatus}</Badge>
              </div>
              ...
              <div className='flex space-x-2'>
                <Button onClick={loadCacheInfo} variant='outline' size='sm' className='flex-1'>
                  <SyncOutlined style={{ fontSize: '16px', marginRight: '8px' }} />
                  Refresh
                </Button>
                <Button
