...
const FLOW_TYPES: AgenticFlowType[] = [
  {
    ...
    description:
      'Instructs the AI to "think out loud" by writing out reasoning step-by-step before providing the final answer.',
    category: 'reasoning',
  },
  {
    ...
    description:
      'AI generates an answer, critiques its own output for flaws, and then revises it based on that critique.',
    category: 'reasoning',
  },
  {
    ...
    description:
      'Simulates a debate between different personas (Architect, Skeptic, Judge) within a single AI to challenge and defend an answer.',
    category: 'reasoning',
  },
  {
    ...
    description:
      'Empowers the AI to use external tools to verify facts and retrieve up-to-date information.',
  ...
  },
  {
    ...
    description:
      'Enhanced RAG that first retrieves many documents, then re-ranks them for relevance before generating an answer.',
    category: 'retrieval',
  },
  {
    ...
    description:
      'AI provides confidence scores with responses and automatically improves low-confidence answers.',
    category: 'validation',
  },
  {
    ...
    description:
      'Applies a set of inviolable rules or principles to guide and constrain AI behavior.',
  ...
  },
  {
    ...
    description:
      'Generates multiple responses to the same prompt and selects the most consistent answer.',
    category: 'validation',
  },
  {
    ...
    description:
      'Applies deterministic checks and formatting rules to validate and correct AI outputs.',
    category: 'validation',
  },
  {
  ...
  },
  {
    ...
    description:
      'Prompts the model to generalize from a specific question to underlying principles before answering.',
    category: 'advanced',
  },
  {
...
const AgenticFlowConfig: React.FC<AgenticFlowConfigProps> = ({
      ...
      case 'MULTI_AGENT_RED_TEAM':
        return {
          personas: {
            ...
            judge:
              'You are the Judge. Your role is to evaluate both perspectives and make a final decision.',
          },
        };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (participantId) {
        await debateClient.configureParticipantAgenticFlow(debateId, participantId, configuration);
      } else {
  ...
  const renderParameterFields = () => {
    ...
    switch (selectedFlowType) {
      ...
      case 'TOOL_CALLING_VERIFICATION':
        return (
          <>
            <FormField label='Enabled Tools' tooltip='Select which external tools the AI can use'>
              <Select
                mode='multiple'
          ...
          <>
            ...
            >
              <InputNumber
                ...
                onChange={value =>
                  setFlowParameters({ ...flowParameters, initialRetrievalCount: value })
                }
                min={10}
                max={100}
                style={{ width: '100%' }}
            ...
            >
              <InputNumber
                ...
                onChange={value =>
                  setFlowParameters({ ...flowParameters, finalDocumentCount: value })
                }
                min={1}
                max={20}
                style={{ width: '100%' }}
          ...
          <>
            ...
            >
              <InputNumber
                ...
                onChange={value =>
                  setFlowParameters({ ...flowParameters, confidenceThreshold: value })
                }
                min={0}
                max={100}
                style={{ width: '100%' }}
            ...
            <FormField label='Improvement Strategy'>
              <Select
                ...
                onChange={value =>
                  setFlowParameters({ ...flowParameters, improvementStrategy: value })
                }
                style={{ width: '100%' }}
              >
      ...
      case 'ENSEMBLE_VOTING':
        return (
          <>
            <FormField label='Ensemble Size' tooltip='Number of responses to generate for voting'>
              <Select
  ...
  return (
    <Card>
      ...
      <Form layout='vertical'>
        ...
        <FormField label='Flow Type' tooltip='Select the reasoning pattern to apply'>
          <Select
