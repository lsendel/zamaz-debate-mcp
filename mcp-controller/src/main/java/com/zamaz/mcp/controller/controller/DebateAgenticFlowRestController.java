...
public class DebateAgenticFlowRestController {
    ...
    @Operation(summary = "Configure debate agentic flow", 
               description = "Configures an agentic flow for an entire debate")
    @ApiResponses({
    ...
    public ResponseEntity<AgenticFlow> configureDebateFlow(
            @Parameter(description = "Debate ID", required = true)
    ...
    @Operation(summary = "Get debate agentic flow", 
               description = "Retrieves the configured agentic flow for a debate")
    @ApiResponses({
    ...
    @Operation(summary = "Get flow recommendation for debate", 
               description = "Recommends an agentic flow type for the debate")
    ...
    @Operation(summary = "Configure participant agentic flow", 
               description = "Configures an agentic flow for a specific AI participant")
    @ApiResponses({
        @ApiResponse(responseCode = "201", description = "Flow configured successfully"),
    ...
    @Operation(summary = "Get participant agentic flow", 
               description = "Retrieves the configured agentic flow for a participant")
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Flow found"),
        @ApiResponse(responseCode = "404", description = "Flow not found")
    })
    ...
    @Operation(summary = "Process response with agentic flow", 
               description = "Processes a response using the participant's configured agentic flow")
    @ApiResponses({
    ...
    public static class ProcessResponseRequest {
        ...
        public int getPreviousResponseCount() { return previousResponseCount; }
