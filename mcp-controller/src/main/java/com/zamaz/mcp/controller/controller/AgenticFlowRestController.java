...
public class AgenticFlowRestController {
    ...
    @GetMapping("/{flowId}")
    @Operation(summary = "Get agentic flow by ID", 
               description = "Retrieves a specific agentic flow configuration")
    @ApiResponses({
    ...
    @Operation(summary = "Get flows by organization", 
               description = "Retrieves all agentic flows for an organization")
    ...
    @Operation(summary = "Get flows by organization and type", 
               description = "Retrieves agentic flows filtered by type")
    public ResponseEntity<List<AgenticFlow>> getFlowsByTypeAndOrganization(
            @Parameter(description = "Organization ID", required = true)
            @PathVariable String organizationId,
            @Parameter(description = "Flow type", required = true)
            @PathVariable AgenticFlowType flowType) {
    ...
    @Operation(summary = "Get active flows", 
               description = "Retrieves all active agentic flows for an organization")
    ...
    @GetMapping("/types")
    @Operation(summary = "Get available flow types", 
               description = "Returns all supported agentic flow types")
    ...
    @Operation(summary = "Get flow templates", 
               description = "Returns all available flow templates")
    public ResponseEntity<Map<String, AgenticFlowApplicationService.AgenticFlowTemplate>> getTemplates() {
        ...
        Map<String, AgenticFlowApplicationService.AgenticFlowTemplate> templates = 
                agenticFlowService.getAvailableTemplates();
        return ResponseEntity.ok(templates);
    }

    @GetMapping("/recommend")
    @Operation(summary = "Get flow recommendation", 
               description = "Recommends a flow type based on context")
    public ResponseEntity<AgenticFlowType> recommendFlowType(
            @Parameter(description = "Prompt text", required = true)
            @RequestParam @NotBlank String prompt,
            @Parameter(description = "Debate type")
            @RequestParam(required = false) String debateType,
            @Parameter(description = "Participant role")
    ...
    @PostMapping
    @Operation(summary = "Create agentic flow", 
               description = "Creates a new agentic flow configuration")
    ...
    @Operation(summary = "Create flow from template", 
               description = "Creates a new agentic flow from a predefined template")
    @ApiResponse(responseCode = "201", description = "Flow created successfully")
    ...
    @PutMapping("/{flowId}")
    @Operation(summary = "Update agentic flow", 
               description = "Updates an existing agentic flow configuration")
    ...
    @Operation(summary = "Delete agentic flow", 
               description = "Deletes an agentic flow configuration")
    ...
    @Operation(summary = "Execute agentic flow", 
               description = "Executes an agentic flow with the given prompt")
    ...
    @Operation(summary = "Execute flow by type", 
               description = "Executes an agentic flow by type without saved configuration")
    ...
    @Schema(description = "Request to create a new agentic flow")
    public static class CreateFlowRequest {
        ...
        public void setFlowType(AgenticFlowType flowType) { this.flowType = flowType; }
    ...
    @Schema(description = "Request to execute a flow")
