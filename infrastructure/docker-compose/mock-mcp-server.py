...
def rag_call_tool():
    ...
    if tool_name == 'index_document':
        ...
        return jsonify({
            "context": "This is the context for your query.",
...
if __name__ == '__main__':
    ...
    print("Mock MCP servers started:")
    print("- Organization: http://localhost:5005")
    print("- LLM: http://localhost:5002")
    print("- Controller: http://localhost:5013")
    print("- RAG: http://localhost:5018")
