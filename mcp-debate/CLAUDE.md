...
The `mcp-debate` service is a Java implementation of the debate management service. It provides core debate domain models and business logic, serving as an alternative or complement to the Python mcp-debate service.
