...
class McpTestResult:
    def __init__(self, test_name: str, service_name: str, tool_name: str, 
                 success: bool, execution_time_ms: int, error_message: str = None, 
                 response: Any = None, metadata: Dict = None):
...
class McpComprehensiveTestFramework:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return McpTestResult(
                    "service_availability", service_name, "health_check",
                    True, execution_time, response=server_info
                )
            else:
                return McpTestResult(
                    "service_availability", service_name, "health_check",
                    False, execution_time, f"HTTP {response.status_code}"
                )
    ...
    def test_list_tools(self, service_name: str, base_url: str) -> McpTestResult:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return McpTestResult(
                    "list_tools", service_name, "list_tools",
                    True, execution_time, response=tools_data,
    ...
    def test_call_tool(self, service_name: str, base_url: str, tool_name: str, 
                      arguments: Dict) -> McpTestResult:
        ...
        try:
            ...
            response = requests.post(f"{base_url}/mcp/call-tool", 
            ...
            if response.status_code == 200:
                ...
                return McpTestResult(
                    f"call_tool_{tool_name}", service_name, tool_name,
                    True, execution_time, response=response_data
                )
            else:
                return McpTestResult(
                    f"call_tool_{tool_name}", service_name, tool_name,
                    False, execution_time, f"HTTP {response.status_code}: {response.text}"
                )
        except Exception as e:
            execution_time = int((time.time() - start_time) * 1000)
            return McpTestResult(
    ...
    def test_context_service(self) -> List[McpTestResult]:
        ...
        test_cases = [
            ('create_context', {
                'name': 'Test Context',
                'description': 'Automated test context'
            }),
            ('append_message', {
            ...
            ('share_context', {
                'contextId': 'test-context-123',
                'targetOrganizationId': 'test-org-789',
                'permission': 'read'
            })
        ]
    ...
    def test_integration_workflow(self) -> List[McpTestResult]:
        ...
        try:
            ...
            org_result = self.test_call_tool('organization', self.services['organization'], 
                                           'create_organization', 
            ...
            debate_result = self.test_call_tool('controller', self.services['controller'],
                                              'create_debate',
            ...
            llm_result = self.test_call_tool('llm', self.services['llm'],
                                           'list_providers', {})
        ...
        workflow_result = McpTestResult(
            ...
            workflow_success, execution_time,
...
def main():
    ...
    print("Testing all MCP services and endpoints...")
