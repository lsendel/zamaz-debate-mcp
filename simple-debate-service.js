...
let debates = [
  ...
  {
    id: "debate-002",    title: "Climate Change Solutions",
    ...
    participants: [
      {
        ...
        llmProvider: "anthropic",        model: "claude-3-sonnet",
  ...
  },
  {
    ...
    participants: [
      ...
      },
      {
        ...
        name: "Claude 3 Opus",
        llmProvider: "anthropic",
        model: "claude-3-opus",        systemPrompt: "You are arguing that automation will create new opportunities and transform rather than eliminate human work."
      }
    ],
    rounds: [],
    maxRounds: 3,
...
app.post('/api/v1/analytics/agentic-flows/compare', (req, res) => {
  const { organizationId, flowTypes } = req.body;
