...
class TestNotificationService:
    ...
    def mock_config(self):
        ...
        return {
            ...
            "default_preferences": {"slack_enabled": True, "email_enabled": True, "github_enabled": True},
        }
    ...
    def sample_recipient(self):
        ...
        return NotificationRecipient(
            ...
            slack_id="U12345678",
            preferences={"slack_enabled": True, "email_enabled": True, "webhook_url": "https://example.com/webhook"},
        )
    ...
    @pytest.mark.asyncio
    async def test_send_notification_all_channels(self, notification_service, sample_recipient, sample_content):
        ...
        results = await notification_service.send_notification(sample_recipient, sample_content, channels)
    ...
    @pytest.mark.asyncio
    async def test_send_slack_notification_success(self, notification_service, sample_recipient, sample_content):
        ...
        with patch("aiohttp.ClientSession") as mock_session:
            ...
            result = await notification_service._send_slack_notification(sample_recipient, sample_content)
    ...
    @pytest.mark.asyncio
    async def test_send_slack_notification_failure(self, notification_service, sample_recipient, sample_content):
    ...
    @pytest.mark.asyncio
    async def test_send_email_notification_success(self, notification_service, sample_recipient, sample_content):
        """Test successful email notification."""
        with patch("smtplib.SMTP") as mock_smtp:
            mock_server = MagicMock()
            mock_smtp.return_value.__enter__.return_value = mock_server

            result = await notification_service._send_email_notification(sample_recipient, sample_content)
    ...
    @pytest.mark.asyncio
    async def test_send_github_notification_success(self, notification_service, sample_recipient, sample_content):
        ...
        with patch("aiohttp.ClientSession") as mock_session:
            ...
            result = await notification_service._send_github_notification(sample_recipient, sample_content)
    ...
    @pytest.mark.asyncio
    async def test_send_webhook_notification_success(self, notification_service, sample_recipient, sample_content):
        ...
        with patch("aiohttp.ClientSession") as mock_session:
            ...
            result = await notification_service._send_webhook_notification(sample_recipient, sample_content)
    ...
    def test_get_preferred_channels_with_preferences(self, notification_service, sample_recipient):
        """Test getting preferred channels based on user preferences."""
        channels = notification_service._get_preferred_channels(sample_recipient, NotificationType.REVIEW_COMPLETED)
    ...
    def test_get_preferred_channels_type_specific(self, notification_service):
        ...
        recipient = NotificationRecipient(
            user_id="user456",
            username="testuser2",
            preferences={"notification_types": {"critical_issue": {"slack": True, "email": True, "github": False}}},
        )

        channels = notification_service._get_preferred_channels(recipient, NotificationType.CRITICAL_ISSUE)
    ...
    def test_create_digest_notification(self, notification_service, sample_recipient):
        ...
        digest = notification_service._create_digest_notification(NotificationType.REVIEW_COMPLETED, notifications)
    ...
    @pytest.mark.asyncio
    async def test_notify_review_completed_helper(self, notification_service, sample_recipient):
        """Test the notify_review_completed helper function."""
        notification_service.send_notification = AsyncMock(return_value={"slack": True, "email": True})

        summary = {"total_issues": 10, "critical_issues": 2, "suggestions_made": 15, "time_saved": "30 minutes"}

        result = await notify_review_completed(notification_service, sample_recipient, "testorg/testrepo", 42, summary)
    ...
    @pytest.mark.asyncio
    async def test_notify_critical_issue_helper(self, notification_service, sample_recipient):
        """Test the notify_critical_issue helper function."""
        notification_service.send_notification = AsyncMock(return_value={"slack": True, "email": True, "github": True})
        ...
        result = await notify_critical_issue(notification_service, sample_recipient, "testorg/testrepo", 100, issue)
    ...
    async def test_send_weekly_summary(self, notification_service, sample_recipient):
        ...
        notification_service.send_notification = AsyncMock(return_value={"email": True})
        ...
        result = await notification_service.send_weekly_summary(sample_recipient, summary_data)
