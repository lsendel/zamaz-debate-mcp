    ...
    async def test_pr_from_fork_security_restrictions(self, e2e_config, mock_github_api):
        ...
        fork_pr = {
            'pull_request': {
                ...
                'head': {
                    'repo': {
                        'full_name': 'external-user/webapp',
                        'fork': True
                    }
                },
                'base': {
...
+    return results'''
    ...
    async def test_weekly_metrics_generation(self, e2e_config):
        ...
        weekly_data = {
            ...
            'critical_issues_prevented': 3,
            'average_review_time': '3.5 minutes',
            'most_active_repos': [
                ('webapp', 20),
                ('api', 15),
                ('mobile', 12)
    ...
    async def test_custom_rule_configuration(self, e2e_config, mock_github_api):
        ...
        custom_rules = {
            'repository': 'testorg/webapp',
            'rules': {
                'max_file_length': 500,
                'forbidden_functions': ['eval', 'exec', 'system'],
                'required_file_headers': True,
                ...
                'enforce_type_hints': True  # Python specific
            }
        }
