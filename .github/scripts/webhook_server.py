...
logging.basicConfig(
    ...
    handlers=[logging.StreamHandler(), logging.FileHandler("kiro_github_webhook.log")],
)
...
def webhook_status():
    ...
    return jsonify({"status": "ok", "version": "0.1.0", "timestamp": datetime.datetime.now().isoformat()}), 200
