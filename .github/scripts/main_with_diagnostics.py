...
from scripts.api import webhook_endpoints, review_endpoints, diagnostic_endpoints
from scripts.core.interfaces import DatabaseInterface, CacheInterface
...
# Create FastAPI app
app = FastAPI(
    title="GitHub Integration Service with Diagnostics",
    version="2.0.0",
    lifespan=lifespan
)
...
async def log_requests(request: Request, call_next):
    ...
    if diagnostic_collector:
        context = diagnostic_collector.start_diagnostic(
