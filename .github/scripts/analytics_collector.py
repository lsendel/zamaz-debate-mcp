...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('kiro_analytics.log')
    ]
)
...
class AnalyticsCollector:
    ...
    def complete_review(self, review_id: str, issues: List[Dict[str, Any]], file_count: int, comment_count: int, suggestion_count: int) -> bool:
        ...
        try:
            ...
            for issue in issues:
                ...
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                ''', (issue_id, review_id, file_path, line_start, line_end, severity, category, rule_id, has_suggestion, False))
    ...
    def record_suggestion_applied(self, review_id: str, file_path: str, line_number: int) -> bool:
        ...
        try:
            ...
            if not result:
                logger.warning(f"No matching issue found for suggestion in review {review_id}, file {file_path}, line {line_number}")
                conn.close()
                return False
            ...
            logger.error(f"Error recording suggestion applied: {str(e)}")
            return False
    
    def record_feedback(self, review_id: str, feedback_type: str, score: int = None, comment: str = None, issue_id: str = None) -> bool:
    ...
    def get_review_stats(self, repo_owner: str = None, repo_name: str = None, days: int = 30) -> Dict[str, Any]:
        ...
        try:
            ...
            stats = {
                ...
                'issues_by_severity': {severity: count for severity, count in severity_results},
                'issues_by_category': {category: count for category, count in category_results}
            }
    ...
    def get_feedback_stats(self, repo_owner: str = None, repo_name: str = None, days: int = 30) -> Dict[str, Any]:
    ...
    def get_metrics(self, repo_owner: str = None, repo_name: str = None, metric_name: str = None, days: int = 30) -> List[Dict[str, Any]]:
        """Get metrics."""
        try:
            conn = sqlite3.connect(self.db_path)
            cursor = conn.cursor()
    ...
    def get_top_issues(self, repo_owner: str = None, repo_name: str = None, days: int = 30, limit: int = 10) -> List[Dict[str, Any]]:
...
def complete_review(review_id: str, issues: List[Dict[str, Any]], file_count: int, comment_count: int, suggestion_count: int) -> bool:
    """Complete a review and store issue data."""
    collector = AnalyticsCollector()
...
def record_feedback(review_id: str, feedback_type: str, score: int = None, comment: str = None, issue_id: str = None) -> bool:
    """Record feedback for a review or issue."""
    collector = AnalyticsCollector()
...
def get_review_stats(repo_owner: str = None, repo_name: str = None, days: int = 30) -> Dict[str, Any]:
    """Get review statistics."""
    collector = AnalyticsCollector()
    return collector.get_review_stats(repo_owner, repo_name, days)

def get_feedback_stats(repo_owner: str = None, repo_name: str = None, days: int = 30) -> Dict[str, Any]:
    """Get feedback statistics."""
    collector = AnalyticsCollector()
    return collector.get_feedback_stats(repo_owner, repo_name, days)

def get_metrics(repo_owner: str = None, repo_name: str = None, metric_name: str = None, days: int = 30) -> List[Dict[str, Any]]:
    """Get metrics."""
    collector = AnalyticsCollector()
    return collector.get_metrics(repo_owner, repo_name, metric_name, days)

def get_top_issues(repo_owner: str = None, repo_name: str = None, days: int = 30, limit: int = 10) -> List[Dict[str, Any]]:
    """Get top issues by frequency."""
    collector = AnalyticsCollector()
