...
class StructuredFormatter(logging.Formatter):
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        if record.levelno >= logging.WARNING:
            log_data["source"] = {"file": record.pathname, "line": record.lineno, "function": record.funcName}
...
def configure_logging(level: str = "INFO", format_type: str = "auto", log_file: str | None = None) -> None:
    """
...
def log_event(logger: logging.Logger, event_type: str, message: str, **kwargs: Any) -> None:
    """
...
def log_error(logger: logging.Logger, error: Exception, message: str, **kwargs: Any) -> None:
    """
    ...
    """
    logger.error(
        message, exc_info=error, extra={"error_type": type(error).__name__, "error_message": str(error), **kwargs}
    )


def log_performance(logger: logging.Logger, operation: str, duration_ms: float, **kwargs: Any) -> None:
    """
    ...
    logger.info(
        ...
        extra={"operation": operation, "duration_ms": duration_ms, "performance_metric": True, **kwargs},
    )
